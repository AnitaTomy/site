    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style={{height: '300px'}}>
                <h3 class="display-4 text-white text-uppercase">Periyar wildlife santuary</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Major Attractions</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Periyar wildlife santuary</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="assets/img/periyar wildlife santuary.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style={{padding: '30px'}}>
                            ...
                            <h2 class="mb-3">Wilderness Wonderland: Discovering Periyar National Park</h2>
                            <p>Biodiversity Haven: Explore the rich biodiversity of the
Western Ghats in Periyar Wildlife Sanctuary. Majestic Wildlife: Encounter elusive tigers, and a diverse
range of wildlife species. Natural Habitat: Witness animals in their natural habitat as
they roam freely through dense forests</p>
                            <p>Thrilling Adventure: Experience the thrill of jungle safaris
via open jeeps or guided boat cruises. Tranquil Lakes: Cruise along serene lakes while taking in
the mist-clad hills and lush landscapes. Captivating Landscapes: Traverse meandering trails and
immerse yourself in captivating forest scenery</p>
                            {/* <h4 class="mb-3">Est dolor lorem et ea</h4> */}
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="assets/img/pexels-sarojgajurel7-1392099.jpg"/>
                            <p>Wildlife Observation: Gain rare opportunities to observe
animals in their untamed environments. Protected Sanctuary: Explore a protected area dedicated
to preserving and showcasing nature's wonders. Educational Insights: Learn about the diverse ecosystems
and the importance of conservation efforts. Unforgettable Memories: Create lasting memories as you
unravel the mysteries of Periyar's wild inhabitants</p>
                            {/* <h5 class="mb-3">Est dolor lorem et ea</h5> */}
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="assets/img/hornbill.jpg"/>
                            <p>Periyar Lake: This large artificial lake formed by the Mullaperiyar Dam is the centerpiece of the park. Boating on the lake offers a chance to spot wildlife along the shores, including elephants, deer, and birds.
                            Nature Walks and Trekking: Explore the park's diverse ecosystems on guided nature walks and treks led by knowledgeable guides. These excursions provide opportunities to learn about the flora, fauna, and conservation efforts in the park.
                            Wildlife Viewing: Periyar is home to a diverse range of wildlife, including elephants, tigers, leopards, Indian bison (gaur), sambar deer, wild boar, and more. Visitors can go on guided safaris or nature walks to observe these majestic creatures in their natural habitat.
