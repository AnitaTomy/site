    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style={{height: '300px'}}>
                <h3 class="display-4 text-white text-uppercase">Offroad adventure</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Major Attractions</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Offroad adventure</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="assets/img/pexels-ahmad-syahrir-107128-761816.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style={{padding: '30px'}}>
                            ...
                            <h2 class="mb-3"> Wild Trails: Thrilling Off-Road Adventures</h2>
                            <p>
                            Embark on an adrenaline-fueled journey into the heart of adventure with our thrilling off-road experience. Leave the beaten path behind as you traverse rugged terrain, conquer steep inclines, and navigate untamed landscapes in the ultimate test of skill and courage.
                            </p>
                            <p>
                            Feel the thrill of the open road as you unleash the full power of your off-road vehicle, tackling obstacles with precision and finesse. Whether you're tearing through muddy trails, splashing through rocky riverbeds, or climbing towering sand dunes, every twist and turn brings a new challenge and a rush of exhilaration.
                            </p>
                            {/* <h4 class="mb-3">Est dolor lorem et ea</h4> */}
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="assets/img/pexels-srkportraits-8310033.jpg"/>
                            <p>
                            But off-road adventure is more than just a test of speed and strength – it's a journey of discovery, a chance to explore hidden gems and secret corners of the world that few have ever seen. From breathtaking mountain vistas to secluded forest glades, every destination offers a new vista to behold and a new story to tell.
                            </p>
                            {/* <h5 class="mb-3">Est dolor lorem et ea</h5> */}
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="assets/img/offroad1.jpg"/>
                            <p>
                            
                            As you journey deeper into the wilderness, you'll forge bonds with fellow adventurers, share stories around the campfire, and create memories that will last a lifetime. Whether you're a seasoned off-road veteran or a novice seeking thrills, our off-road experience promises an unforgettable adventure filled with excitement, camaraderie, and the raw beauty of the great outdoors.
                            So buckle up, rev your engines, and prepare to unleash your inner daredevil as you embark on the off-road adventure of a lifetime. From the rugged trails of the backcountry to the uncharted wilderness beyond, the road less traveled awaits – are you ready to answer the call?
