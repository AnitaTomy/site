    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style={{height: '300px'}}>
                <h3 class="display-4 text-white text-uppercase">Kalaripayattu</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Major Attractions</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Kalaripayattu</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="assets/img/kalaripayattu.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style={{padding: '30px'}}>
                            ...
                            <h2 class="mb-3">Legends Unleashed: The Ancient Art of Kalaripayattu</h2>
                            <p>
                            Cultural Authenticity: Deeply rooted in Indian heritage, offering an authentic
cultural experience. Physical Fitness: Rigorous training for strength, flexibility, and overall physical
well-being. Unique Self-Defense: Practical self-defense techniques appealing to safety- conscious travelers.
                            </p>
                            <p>
                            Graceful Movements: Fluid and graceful martial art form that mesmerizes
onlookers. Mind-Body Connection: Emphasizes mental focus and synchronization with
physical movements. Traditional Weaponry: Learning to wield ancient weapons adds an element of
intrigue
                            </p>
                            {/* <h4 class="mb-3">Est dolor lorem et ea</h4> */}
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="assets/img/kalari1.jpg"/>
                            <p>
                            Cultural Immersion: Provides insight into Indian history and traditions through
practice. Performance Spectacle: Captivating performances with music and choreography. Holistic Challenge: Mental and physical engagement for a holistic experience. Traveler-Friendly: Short-term training programs accommodate tourists' schedules. Experiential Learning: Active participation in a 
                            </p>
                            {/* <h5 class="mb-3">Est dolor lorem et ea</h5> */}
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="assets/img/pexels-inspiredimages-133394.jpg"/>
                            <p>
                            As you step onto the training ground, you're greeted by the rhythmic sounds of feet striking the earth, the clang of metal against metal, and the focused intensity of seasoned warriors honing their craft. Every movement is a dance, a symphony of strength, agility, and precision, as practitioners master the intricate techniques passed down through generations.
                            </p>
                        </div>
                    </div>
                    {/* <!-- Blog Detail End --> */}  
