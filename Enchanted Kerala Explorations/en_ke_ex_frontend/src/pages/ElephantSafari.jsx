    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style={{height: '300px'}}>
                <h3 class="display-4 text-white text-uppercase">Elephant safari</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Major Attractions</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Elephant safari</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="assets/img/elephant ride.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style={{padding: '30px'}}>
                            ...
                            <h2 class="mb-3">Jungle Majesty: Unforgettable Elephant Safari</h2>
                            <p>
                            Half hour program: 20 minutes ride, 10minutes photo session One hour program: 30 minutes ride,elephant bath and show, photosOne and half hour program: 40
                            minutes ride, timber dragging, elephant bath and shower, feeding and photo session
                            </p>
                            <p>
                            Step into a world of majestic wonder and embark on an unforgettable journey aboard an elephant safari. Feel the rhythm of the jungle beneath you as these gentle giants lead you through lush forests and hidden pathways, each step unveiling a new adventure.
                            </p>
                            {/* <h4 class="mb-3">Est dolor lorem et ea</h4> */}
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="assets/img/elephant1.jpg"/>
                            <p>
                            With the sway of the elephant's mighty stride, you are transported into the heart of nature's embrace. Towering trees and vibrant foliage surround you, alive with the sounds of exotic birdsong and the rustle of unseen creatures. Every moment is filled with anticipation as you traverse untamed landscapes, eager to discover the secrets of the wilderness.
                            </p>
                            {/* <h5 class="mb-3">Est dolor lorem et ea</h5> */}
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="assets/img/pexels-inspiredimages-133394.jpg"/>
                            <p>
                            As you meander along ancient trails, keep your eyes peeled for glimpses of elusive wildlife. Spot a majestic tiger prowling through the undergrowth, catch a glimpse of playful monkeys swinging from branch to branch, or marvel at the grace of deer as they graze peacefully in their natural habitat.

But it's not just about the sights – it's about the connection forged between human and elephant, a bond that transcends language and culture. Feel the gentle sway of your mount's back beneath you, a reminder of the centuries-old partnership between these magnificent creatures and mankind.
                            </p>
                        </div>
                    </div>
                    {/* <!-- Blog Detail End --> */}  
