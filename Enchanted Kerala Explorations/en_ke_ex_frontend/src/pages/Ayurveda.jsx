    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style={{height: '300px'}}>
                <h3 class="display-4 text-white text-uppercase">Ayurveda</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Major Attractions</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Ayurveda</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="assets/img/ayurveda.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="bg-white mb-3" style={{padding: '30px'}}>
                            ...
                            <h2 class="mb-3">Harmony of Healing: Ayurveda's Timeless Wisdom</h2>
                            <p>
                            Enter the realm of Ayurveda, where ancient wisdom meets modern wellness in a harmonious fusion of healing and rejuvenation. Journey back in time to discover the secrets of this holistic system of medicine, rooted in the sacred texts of India and steeped in centuries of tradition.
                            </p>
                            <p>
                            Ayurveda, often referred to as the "science of life," offers a holistic approach to health and well-being, treating not just the symptoms of illness, but the root causes as well. Through a delicate balance of herbal remedies, dietary adjustments, therapeutic treatments, and lifestyle practices, Ayurveda seeks to restore harmony to the body, mind, and spirit, unlocking the body's innate ability to heal itself.
                            </p>
                            {/* <h4 class="mb-3">Est dolor lorem et ea</h4> */}
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="assets/img/ayur1.jpg"/>
                            <p>
                            Step into a world of serenity and tranquility as you embark on your Ayurvedic journey. From lush tropical gardens to serene spa sanctuaries, every aspect of your experience is designed to soothe the senses and nurture the soul. Feel the stress and tension melt away as skilled therapists pamper you with gentle massages, aromatic oils, and soothing herbal poultices, leaving you feeling refreshed, rejuvenated, and revitalized.
                            </p>
                            {/* <h5 class="mb-3">Est dolor lorem et ea</h5> */}
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="assets/img/ayur2.jpg"/>
                            <p>
                            
                            But Ayurveda is more than just a spa treatment – it's a way of life, a philosophy that teaches us to live in harmony with nature and honor the rhythms of the seasons. Through mindful practices such as yoga, meditation, and pranayama, Ayurveda empowers us to cultivate inner peace, balance, and resilience, enabling us to thrive in an ever-changing world.
                            So come, immerse yourself in the healing waters of Ayurveda, and discover the transformative power of this ancient science. Whether you seek relief from physical ailments, emotional imbalances, or simply a deeper connection to yourself and the world around you, Ayurveda offers a path to wholeness, vitality, and radiant health.
                            </p>
                        </div>
                    </div>
                    {/* <!-- Blog Detail End --> */}  
